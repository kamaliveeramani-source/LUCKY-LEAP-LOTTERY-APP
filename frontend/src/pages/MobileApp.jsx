      ...
      <div className="page-content">
        <div className="text-center" style={{ marginBottom: "22px" }}>
          ...
          <p className="text-muted" style={{ margin: 0 }}>
            Download the Lucky Horse Lotteries mobile experience to buy tickets, track draws, and manage your wallet on the go.
          </p>
        </div>
        ...
        <div className="card-panel card-panel-strong" style={{ marginBottom: "20px" }}>
          <div style={{ display: "grid", gap: "18px" }}>
            <div>
              <h4 style={{ color: "var(--accent)", marginBottom: "10px" }}>Why the Lucky Horse Lotteries App?</h4>
